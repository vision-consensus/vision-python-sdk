...
class AsyncContract(object):
    ...
    def __init__(
        ...
        *,
        ...
        client: "visionpy.AsyncVision" = None,
    ):
    ...
    def update_user_resource_percent(self, percent: int) -> "visionpy.async_vision.AsyncTransactionBuilder":
    ...
    def update_origin_entropy_limit(self, limit: int) -> "visionpy.async_vision.AsyncTransactionBuilder":
    ...
    def clear_abi(self) -> "visionpy.async_vision.AsyncTransactionBuilder":
        """Clear contract ABI."""
        if self.origin_address != self.owner_address:
            raise RuntimeError("origin address and owner address mismatch")
    ...
    def as_shielded_vrc20(self) -> "ShieldedVRC20":
        return ShieldedVRC20(self)
...
class AsyncContractMethod(object):
    ...
    def with_owner(self, addr: str) -> "AsyncContractMethod":
        ...
        :meth:`TransactionBuilder.with_owner() <visionpy.async_vision.AsyncTransactionBuilder.with_owner>`.
        """
...
class ShieldedVRC20(object):
    ...
    @property
    async def vrc20(self) -> AsyncContract:
    ...
    async def get_rcm(self) -> str:
        return (await self._client.provider.make_request("wallet/gevrcm"))["value"]

    async def mint(
        self, taddr: str, zaddr: str, amount: int, memo: str = ""
    ) -> "visionpy.async_vision.AsyncTransactionBuilder":
    ...
    async def scan_incoming_notes(self, zkey: dict, start_block_number: int, end_block_number: int = None) -> list:
        ...
        ret = await self._client.provider.make_request("wallet/scanshieldedvrc20notesbyivk", payload)
        self._client._handle_api_error(ret)
    ...
    async def scan_outgoing_notes(
        ...
        ret = await self._client.provider.make_request("wallet/scanshieldedvrc20notesbyovk", payload)
        self._client._handle_api_error(ret)
    ...
    async def is_note_spent(self, zkey: dict, note: dict) -> bool:
        ...
        ret = await self._client.provider.make_request("wallet/isshieldedvrc20contractnotespent", payload)
