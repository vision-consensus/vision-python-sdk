...
class TransactionRet(dict):
    def __init__(self, iterable, client: "Vision", method: ContractMethod = None):
...
class Transaction(object):
    ...
    def __init__(self, raw_data: dict, client: "Vision" = None, method: ContractMethod = None,
    ...
    @classmethod
    def from_json(cls, data: Union[str, dict], client: "Vision" = None):
...
class TransactionBuilder(object):
    ...
    def __init__(self, inner: dict, client: "Vision", method: ContractMethod = None):
        self._client = client
        self._raw_data = {
            "contract": [inner],
    ...
    def with_owner(self, addr: VAddress) -> "TransactionBuilder":
...
class Vs(object):
    ...
    def transfer(self, from_: VAddress, to: VAddress, amount: int) -> TransactionBuilder:
    ...
    def asset_transfer(self, from_: VAddress, to: VAddress, amount: int, token_id: int) -> TransactionBuilder:
    ...
    def account_permission_update(self, owner: VAddress, perm: dict) -> "TransactionBuilder":
    ...
    def account_update(self, owner: VAddress, name: str) -> "TransactionBuilder":
    ...
    def create_witness(self, owner: VAddress, url: str) -> "TransactionBuilder":
    ...
    def vote_witness(self, owner: VAddress, *votes: Tuple[VAddress, int]) -> "TransactionBuilder":
    ...
    def deploy_contract(self, owner: VAddress, contract: Contract) -> "TransactionBuilder":
...
class Vision(object):
    ...
    def get_account(self, addr: VAddress) -> dict:
    ...
    def get_account_resource(self, addr: VAddress) -> dict:
    ...
    def get_account_permission(self, addr: VAddress) -> dict:
    ...
    def get_contract(self, addr: VAddress) -> Contract:
